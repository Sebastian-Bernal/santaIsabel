...
<template>
    <div
        class="px-6 pt-7 z-1 flex flex-col items-center h-[90%]">
        <h1 class="text-3xl text-[var(--color-default)] dark:text-white font-bold mb-3 text-center">{{ datos.titulo }}</h1>
        <!-- Formulario -->
