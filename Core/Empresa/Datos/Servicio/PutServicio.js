...
export const validarYEnviarPutDatosServicio = async (datos) => {
    ...
    return await enviarFormularioPutServicio(datos);
};

// Funcion para validar conexion a internet y enviar fomulario a API y IndexedDB
export const enviarFormularioPutServicio = async (datos, reintento = false) => {
    const notificacionesStore = useNotificacionesStore();
        ...
        try {
            ...
            if (respuesta.success) {
                ...
                const datosActualizadosLocal = {
                    Servicio: {
                        id_temporal: datos.Servicio.id_temporal,
                        sincronizado: 1,
