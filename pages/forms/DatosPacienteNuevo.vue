    ...
    <Fondo>
        <Formulario :datos="{
            ...
            botones: [
                ...
                { texto: 'Registrar', ruta: '', color: 'bg-[var(--color-primary)]', submit: formComplete ? true : false }
            ],
            ...
            <Section class="md:flex-row flex-col">
                <Input v-model="formData.Paciente.name" type="text" id="nombre" name="nombre" placeholder="Nombres y Apellidos"
            ...
            <div class="w-full md:w-4/5 mt-3">
            ...
            <Section>
                ...
                <Input v-model="formData.Paciente.municipio" type="text" id="municipio" name="municipio" placeholder="Municipio"
            ...
            <Section>
                ...
                <Input v-model="formData.Paciente.direccion" type="text" id="direccion" name="direccion" placeholder="Direccion"
                    tamaño="md:w-1/2 w-full" />
            </Section>

            <Section>
                <Input v-model="formData.Paciente.celular" type="number" id="celular" name="celular" placeholder="Celular"
                    tamaño="w-1/2" />
                <Input v-model="formData.Paciente.telefono" type="number" id="telefono" name="telefono" placeholder="Telefono"
                    tamaño="w-1/2" />
            </Section>
