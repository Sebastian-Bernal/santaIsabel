    ...
    <div
        ...
        <div class="w-full" role="table">
            ...
            <div class="flex w-max min-w-full relative">
                ...
                <!-- COLUMNAS FIJAS -->
                <div v-if="props.Propiedades.configuracion.tipo === 'pinned'" class="sticky top-0 z-20 grid py-4 px-2 justify-between text-xs font-semibold text-center bg-[var(--color-default)] dark:bg-[var(--color-default-600)] border-b border-gray-200 dark:border-gray-700 text-gray-50! dark:text-gray-100!" 
                ...
                <div ref="headerInner" class="w-full sticky top-0 z-3 grid py-4 px-2 justify-between text-xs font-semibold text-center bg-[var(--color-default)] dark:bg-[var(--color-default-600)] border-b border-gray-200 dark:border-gray-700 text-gray-50! dark:text-gray-100!"
                        ...
                        <div v-if="Propiedades.acciones.botones"
                            ...
                            <div class="relative inline-block text-left">
                                <button @click="mostrarAcciones(id)"
                                    ...
                                    <i class="fa-solid fa-ellipsis-vertical text-gray-600 dark:text-gray-200 text-xs"></i>
                                </button>
